...
class Accumulator(avango.script.Script):
    ...
    def evaluate(self):
        ...
        # multiply existing transformation matrix with new rotation
        self.sf_mat.value = self.sf_mat.value * avango.gua.make_rot_mat(self.sf_rot_input.value,0.0,1.0,0.0)
...
class Hinge:
    ...
    # constructor
    # Exercise 3.3 : made two member variables for min and max constraints
    def __init__(self,
        PARENT_NODE = None,
        ...
        SF_ROT_INPUT = None,
        ROT_CONSTRAINT_MIN = -180.0,
        ROT_CONSTRAINT_MAX = 180.0,
        ):
        ...
        # Exercise 3.3: init Constraint here
        # ...
